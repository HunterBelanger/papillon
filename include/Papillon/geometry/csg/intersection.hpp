 ...
 *
 * */
#ifndef PAPILLON_INTERSECTION_H
#define PAPILLON_INTERSECTION_H
...
namespace pmc {
  ...
  class Intersection : public Volume {
    public:
      Intersection(std::shared_ptr<Volume> r1, std::shared_ptr<Volume> r2, uint32_t id);
