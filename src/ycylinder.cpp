...
namespace pmc {
  ...
  Surface::Side YCylinder::sign(const Position& r, const Direction& u) const {
    double x = r.x() - x0;
    double z = r.z() - z0;
  ...
  double YCylinder::distance(const Position& r, const Direction& u, uint32_t on_surf) const {
